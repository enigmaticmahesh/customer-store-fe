...
const FooterTop = () => {
    ...
    return (
        <div id="downloadApp" className="bg-primary/5 dark:bg-primary/10 py-10 lg:py-16 bg-repeat bg-center overflow-hidden border-t border-border/50" >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-2 md:gap-3 lg:gap-3 items-center">
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-8 flex mx-auto justify-center text-center">
                            ...
                            <Link
                                to="/"
                                // to={`${home?.daily_need_google_link}`}
                                target="_blank"
                                rel="noreferrer"
                            >
                                <ImageWithFallback
