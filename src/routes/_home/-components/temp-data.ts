export const storeCustomizationSetting = {
  navbar: {
    ...
    logo: "https://res.cloudinary.com/ahossain/image/upload/v1772958903/kachabazar/logo-light.svg",
  },
  home: {
    coupon_status: true,
  ...
  slider: {
    ...
    both_slider: false,
    first_img:
      "https://ik.imagekit.io/eclaygb3yqo/carousel/brooke-lark-08bOYnH_r_E-unsplash%20(1)_HJKJ2S4uf.jpg",
    first_title: {
    ...
    second_img:
      "https://ik.imagekit.io/eclaygb3yqo/carousel/katherine-chase-4MMK78S7eyk-unsplash%20(1)_g6L6OGQKh.jpg",
    second_title: {
    ...
    third_img:
      "https://ik.imagekit.io/eclaygb3yqo/carousel/davies-designs-studio-HJa6GKpdHEA-unsplash_2lWSSnzxI.jpg",
    third_title: {
    ...
    four_img:
      "https://ik.imagekit.io/eclaygb3yqo/carousel/pexels-vanessa-loring-5965991_hqO9u39pF.jpg",
    four_title: {
      en: "The Best Quality Products Guaranteed!",
      de: "Die besten Qualitätsprodukte garantiert!",
    },
    ...
    five_img:
      "https://ik.imagekit.io/eclaygb3yqo/carousel/pexels-karola-g-5202199_Kh51u7CEn.jpg",
    five_title: {
      en: "Best Different Type of Grocery Store",
      de: "Bestes anderes Lebensmittelgeschäft",
    },
  ...
  footer: {
    ...
    block4_logo:
      "https://res.cloudinary.com/ahossain/image/upload/v1772959014/kachabazar/logo-color.svg",
    block4_address: {
  ...
  seo: {
    favicon:
      "https://res.cloudinary.com/ahossain/image/upload/v1700903173/kachabazar/favicon.png",
    meta_title: "KachaBazar - React Next eCommerce Template",
    meta_description:
      "KachaBazar is a React Next.js based grocery & organic food store eCommerce template. Shop fresh groceries, organic fruits, vegetables, dairy, and everyday essentials online with fast delivery.",
    meta_keywords:
      "ecommerce, online store, grocery store, organic food, fresh vegetables, fruits, dairy, react ecommerce, next.js store, kachabazar, online grocery, food delivery, organic products, health food, supermarket online",
...
export const coupons = [
  {
    ...
    logo: "https://images.pexels.com/photos/35810222/pexels-photo-35810222.jpeg",
    couponCode: "AUGUST24",
    ...
    status: "show",
    __v: 0,
    createdAt: "2026-06-11T14:24:10.161Z",
    updatedAt: "2026-06-11T14:24:10.161Z",
  },
  {
    _id: "6a2ac50aded55f49ae1b9f01",
    title: {
  ...
  },
  {
    ...
    logo: "https://i.ibb.co/wBBYm7j/ins2.jpg",
    couponCode: "SUMMER26",
...
export type Category = (typeof categories)[number]["children"][number];
