        ...
        <div>
                ...
                <div className="flex lg:flex-row md:flex-row sm:flex-row flex-col justify-between pt-4">
                    <div className="mb-3 md:mb-0 lg:mb-0 flex flex-col">
                        ...
                        {data?.createdAt !== undefined && (
                            <span>{getReadableDate(data?.createdAt)}</span>
                        )}
                        </span>
                    </div>
                    <div className="mb-3 md:mb-0 lg:mb-0 flex flex-col">
                ...
                <div className="-my-2 overflow-x-auto">
                    <table className="table-auto min-w-full border border-border divide-y divide-border">
                        ...
                        <tr className="text-xs bg-muted">
                            <th scope="col" className="font-semibold px-6 py-2 text-muted-foreground uppercase tracking-wider text-left" >
                                Sr.
                            </th>
                            <th scope="col" className="font-semibold px-6 py-2 text-muted-foreground uppercase tracking-wider text-left" >
                                Product Name
                            </th>
                            <th scope="col" className="font-semibold px-6 py-2 text-muted-foreground uppercase tracking-wider text-center" >
                                Quantity
                            </th>
                            <th scope="col" className="font-semibold px-6 py-2 text-muted-foreground uppercase tracking-wider text-center" >
                                Item Price
                            ...
                            <th scope="col" className="font-semibold px-6 py-2 text-muted-foreground uppercase tracking-wider text-right" >
                                Amount
                            </th>
                        </tr>
                        </thead>
                        {/* <OrderTable data={data} /> */}
                        <InvoiceOrderTableBody />
                    </table>
                </div>
            </div>
            ...
            <div className="border-t border-b border-border p-10 bg-accent">
                ...
                <div className="mb-3 md:mb-0 lg:mb-0  flex flex-col sm:flex-wrap">
                    ...
                    <span className="text-sm text-muted-foreground font-semibold block">
                        {formatPriceString(data?.shippingCost.toString())}
                    </span>
                </div>
                <div className="mb-3 md:mb-0 lg:mb-0  flex flex-col sm:flex-wrap">
                    <span className="mb-1 font-bold text-sm uppercase text-muted-foreground block">
                    ...
                    <span className="text-sm text-muted-foreground font-semibold block">
                        {formatPriceString(data?.discount.toString())}
                    </span>
                </div>
                <div className="flex flex-col sm:flex-wrap">
                    ...
                    <span className="text-2xl font-bold text-red-500 block">
                        {formatPriceString(data?.total.toString())}
                    </span>
                </div>
                </div>
            </div>
