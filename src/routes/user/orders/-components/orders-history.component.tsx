    ...
    return (
        <>
            ...
            <td className="px-3 py-3 text-sm whitespace-nowrap text-muted-foreground">
                ...
                {getReadableDate(order.createdAt)}
                </span>
            </td>
            ...
            <td className="px-3 py-3 text-sm whitespace-nowrap text-muted-foreground">
                <span className="text-sm">{formatPriceString(order.shippingCost.toString())}</span>
            </td>
            <td className="px-3 py-3 text-sm whitespace-nowrap text-muted-foreground">
                <span className="text-sm font-bold">{formatPriceString(order?.total.toString())}</span>
            </td>
        </>
    )
}
