...
import { Truck, RefreshCcw, Check, ShoppingCart, type LucideIcon } from 'lucide-react'

const Card = ({ title, Icon, quantity, className }: {title: string, Icon: LucideIcon, quantity: number, className: string}) => {
  return (
